...
class Reduction:
    ...
    def get_bias(self):
        ...
        for ff in self.bias_files:
            self.tempbias_frames = fits.getdata(ff)
            #self.bias_frames.append(self.tempbias_frames.flatten())
        self.bias_frames = np.array(self.tempbias_frames)
        print("bias")
    ...
    def get_dark(self):
        ...
        for ff in self.dark_files:
            ...
            self.dark_frames.append((
                                            self.tempdark_frames.flatten() + 1000 - self.master_bias) / self.exptime)  # allazw to masterbiasvis se masterbias kai to temdarkframes me flatten
    ...
    def get_flat(self):
        ...
        for ff in self.flat_files:
            ...
            self.flat_frames.append(
                (self.tempbias_frames + 1000 - self.master_bias_vis - self.exptime2) * self.master_dark_vis)
...
data_dir = (r'home/Desktop/hatp32')
data_dir2 = r'home/Desktop/hatp32/reduced'
